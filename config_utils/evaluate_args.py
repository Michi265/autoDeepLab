...
def obtain_evaluate_args():
    ...
    parser.add_argument('--net_arch', default='run/cityscapes/pippo/experiment_0/network_path.npy', type=str)
    parser.add_argument('--cell_arch', default='run/cityscapes/pippo/experiment_0/genotype.npy', type=str)
